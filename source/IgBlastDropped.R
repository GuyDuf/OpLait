...
temp <- rbind(
  gather(data = prc.lost.ig.frame, key = Class, value = Percent)[-6, ],
...
tot.per.ig <- unlist(list(
  G1 = sum(
    frct.lost.ordered[frct.lost.ordered$Class == "G1" & frct.lost.ordered$Reason == "Frameshift", ]$Percent,
  ...
  G2 = sum(
    frct.lost.ordered[frct.lost.ordered$Class == "G2" & frct.lost.ordered$Reason == "Frameshift", ]$Percent,
  ...
  G3 = sum(
    frct.lost.ordered[frct.lost.ordered$Class == "G3" & frct.lost.ordered$Reason == "Frameshift", ]$Percent,
  ...
  GM1 = sum(
    frct.lost.ordered[frct.lost.ordered$Class == "GM1" & frct.lost.ordered$Reason == "Frameshift", ]$Percent,
  ...
  GM2 = sum(
    frct.lost.ordered[frct.lost.ordered$Class == "GM2" & frct.lost.ordered$Reason == "Frameshift", ]$Percent,
